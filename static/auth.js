...
function check_dup() {
    ...
    if (!is_nickname(username)) {
        $("#help-id")
            .text(
                "For your id, please enter 2-10 characters, numbers, or the following special characters (._-)"
            )
            .removeClass("is-safe")
            .addClass("is-danger");
        $("#input-username").focus();
...
function sign_up() {
    ...
    if (password === "") {
        ...
        $("#help-password")
            .text(
                "For your password, please enter 8-20 characters, numbers, or the following special characters (!@#$%^&*)"
            )
            .removeClass("is-safe")
            .addClass("is-danger");
        $("#input-password").focus();
